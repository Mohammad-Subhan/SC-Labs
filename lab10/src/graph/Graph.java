...
public interface Graph<L> {
	...
	public static <L> Graph<L> empty() {
        // Default empty graph implementation used by GraphStaticTest.
        // Choose ConcreteEdgesGraph as the default concrete implementation.
        // The cast is safe because ConcreteEdgesGraph implements Graph<String>,
        // and the static method is generic; when called by tests they use Graph<String>.
        @SuppressWarnings("unchecked")
        Graph<L> g = (Graph<L>) new ConcreteEdgesGraph();
        return g;
    }
